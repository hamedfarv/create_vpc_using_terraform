...
resource "aws_vpc" "application_vpc" {
  cidr_block           = var.vpc_ciddrr_block ##here
...
resource "aws_subnet" "public_subnets" {
  vpc_id                  = aws_vpc.application_vpc.id ##here
...
resource "aws_route_table" "public_rt" {
  ...
  route {
    ...
    gateway_id = aws_internet_gateway.internet_gw.id ## here
  }
...
resource "aws_route_table_association" "private_rta" {
  ...
  route_table_id = aws_route_table.lambda_function_rt[0].id ## here
